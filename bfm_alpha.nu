...
def build [] {
    ...
    cd 'C:\Users\felixb\BIOS\HpSpringsA\HpPlatformPkg\' 
    HpBldSprings.bat
    cd ~
}
...
def find_build [] {
    mut binary = ""
    if (ls C:\Users\felixb\BIOS\HpSpringsA\HpPlatformPkg\BLD\FV\*_64.bin | length) > 0 {
        print -n $"Found binary in build folder: "
        $binary = (ls C:\Users\felixb\BIOS\HpSpringsA\HpPlatformPkg\BLD\FV\*_64.bin | first)
        print_info $binary
    }
    $binary
}
